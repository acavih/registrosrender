<template>
  <v-dialog v-model="dialog">
    <template v-slot:activator="{ on, attrs }">
      <v-btn style="margin-left: 10px;" :disabled="disabled" elevation="0" color="primary" dark v-bind="attrs" v-on="on">
      ...
      <v-card-text>
        ...
        >
          <template #[`item.actions`]="{item}">
            <v-btn target="_blank" color="primary" small elevation="0" :to="'/admin/partners/' + item._id">Ver detalles</v-btn>
          </template>
